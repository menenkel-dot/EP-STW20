...
const Datenschutz: React.FC = () => {
  return (
    <div className="max-w-4xl mx-auto">
      <h1 className="text-3xl font-bold text-gray-800 dark:text-gray-100 mb-6">Datenschutzerklärung</h1>
      
      <Card>
        <div className="p-6 space-y-6 text-gray-700 dark:text-gray-300">
          <section>
            <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-100 mb-3">1. Verantwortliche Stelle</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-100 mb-3">2. Erhebung und Speicherung personenbezogener Daten</h2>
            <p className="mb-2">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-100 mb-3">3. Zweck der Datenverarbeitung</h2>
            <p className="mb-2">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-100 mb-3">4. Rechtsgrundlage</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-100 mb-3">5. Datensicherheit</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-100 mb-3">6. Speicherdauer</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-100 mb-3">7. Cookies und localStorage</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-100 mb-3">8. Ihre Rechte</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-100 mb-3">9. Datenexport</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-100 mb-3">10. Beschwerderecht</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-100 mb-3">11. Änderungen der Datenschutzerklärung</h2>
            <p>
